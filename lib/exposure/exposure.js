...
export default class Exposure {
  ...
  initCountMethod () {
    ...
    Meteor.methods({
      async [this.name + '.count'] (body) {
        return await collection.find(body.$filters || {}, {}, this.userId, false).countAsync()
      }
    })
  }
  ...
  async initSecurity () {
    ...
    const find = await collection.find // .bind(collection)
    ...
    collection.findOneAsync = async function (
      ...
      return await collection.findOneAsync(filters, options)
    }
  }
